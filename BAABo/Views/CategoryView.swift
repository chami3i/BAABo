    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                if showResultPopup {
                    ZStack {
                        Color.black.opacity(0.4)        // 전체 화면 어둡게
                            .ignoresSafeArea()
                            .onTapGesture {
                        ...
                        .frame(width: 274, height: 365)
                        .background(
                            RoundedRectangle(cornerRadius: 20)
                                .fill(
                                    LinearGradient(colors: [Color("7_gradientOrange"), Color("8_gradientYellow")], startPoint: .topLeading, endPoint: .bottomTrailing)
                                )
                        )
                        .navigationBarBackButtonHidden(true)
